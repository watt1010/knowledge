...
import com.inspur.tax.mvc.dao.QADao;
...
public class QAService {
     ...
     */
    public List<Map<String, String>> queryQuestions(int start, int end,String user_id) {
     ...
     * 根据问题的id查询答案
     */
    public Map<String, String> queryAnswer(String key, String user_id) {
